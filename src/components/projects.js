        ...
        <p>
           {record.ProjectURL? <span className="projectLink"><a href={record.ProjectURL}> {record.ProjectName}</a></span> :<span>{record.ProjectName}</span> }
            ...
            <div className="projectFotos" align="center">
              ...
              {record.ProjectImage2 == null ? '' : <span ><img src= {'images/' + record.ProjectImage2} loading="lazy" className="foto2" alt={record.ProjectName} id={record.idnew_table} onClick={imageClick} /></span> } 
